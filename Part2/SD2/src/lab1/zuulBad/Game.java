...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        level2 = new Room("in level 2 office");
        
        // initialise room exits
        outside.setExits(library, theater, lab, pub, null, null);
        theater.setExits(null, null, null, outside, null, null);
        pub.setExits(null, outside, null, null, null, dungeons);
        lab.setExits(outside, office, null, null, null, null);
        office.setExits(null, null, null, lab, level2, null);
        library.setExits(null, null, outside, null, null, null);
        dungeons.setExits(null, null, null, null, pub, null);
        level2.setExits(null, null, null, null, null, office);
    ...
    private void printLocation() {
    	System.out.println("Your current location is " + currentRoom.getDescription());
    }
